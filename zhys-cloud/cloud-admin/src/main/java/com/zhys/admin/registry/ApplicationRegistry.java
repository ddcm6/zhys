package com.zhys.admin.registry;

import com.zhys.admin.config.ZhysAdminServerProperties;
...
public class ApplicationRegistry implements ApplicationEventPublisherAware {
    ...
    private final ZhysAdminServerProperties serverProperties;

    private final RestTemplate restTemplate;

    private ApplicationEventPublisher eventPublisher;

    public ApplicationRegistry(ApplicationStore applicationStore, DiscoveryClient discoveryClient, ServiceInstanceConverter instanceConverter, TaskScheduler taskScheduler, ZhysAdminServerProperties serverProperties, RestTemplate restTemplate) {
