...
import com.zhys.common.redis.limit.RedisLimit;
import com.zhys.common.redis.limit.intercept.SpringMvcIntercept;
...
@ConditionalOnProperty(name = "zhys.redis.limit.enabled", havingValue = "true")
