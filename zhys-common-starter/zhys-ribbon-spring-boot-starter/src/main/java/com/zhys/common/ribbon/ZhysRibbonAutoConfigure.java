...
import com.zhys.common.ribbon.config.ZhysRestTemplateProperties;
...
@EnableConfigurationProperties(ZhysRestTemplateProperties.class)
public class ZhysRibbonAutoConfigure implements WebMvcConfigurer {
    ...
    @Autowired
    private ZhysRestTemplateProperties restTemplateProperties;
