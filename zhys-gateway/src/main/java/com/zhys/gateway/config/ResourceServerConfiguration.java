...
import com.zhys.common.config.ZhysOauth2Properties;
import com.zhys.gateway.handler.ZhysAccessDeniedHandler;
...
@EnableConfigurationProperties(ZhysOauth2Properties.class)
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {

    private static final String PUBLIC_KEY = "pubkey.txt";

    @Autowired
    private ZhysOauth2Properties oauth2Properties;

    @Autowired
    private OAuth2WebSecurityExpressionHandler expressionHandler;

    @Autowired
    private ZhysAccessDeniedHandler accessDeniedHandler;
